...
const Manager = () => {
    ...
    const handleedit = async(site, username, password, id) => {
            ...
            <div className="mycomponent flex flex-col items-center">
                ...
                <table className="table-auto w-full shadow-lg shadow-purple-500/50 rounded-lg ">
                    <thead className='bg-purple-400 font-bold w-full'>
                        <tr>
                            <th className='py-2 w-[33%] border border-white'>Site</th>
                            <th className='py-2 w-[24%] border border-white'>UserName</th>
                            <th className='py-2 w-[24%] border border-white'>Password</th>
                        ...
                        <tbody className=' bg-purple-100 w-full '>
                            {
                                passwordArray.map((item, index) => {
                                    return <tr className='' key={index}>
                                        <td className='text-center break-all border border-white py-1 w-[33%]'><a href={item.site} target="_blank">{item.site}</a></td>
                                        <td className='text-center border border-white py-1 w-[24%]'>{item.username}</td>
                                        <td className='text-center border border-white py-1 w-[24%]'>{item.password} </td>
